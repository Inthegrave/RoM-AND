...
// BUG - Trade Denial - end
	...
	DllExport void setRouteHelp(CvWStringBuffer &szBuffer, RouteTypes eRoute, bool bCivilopediaText = false);
...
// Movement Limits by 45deg - START
	void buildExtendMovementLimitsString( CvWStringBuffer& szBuffer, TechTypes eTech, bool bList = false, bool bPlayerContext = false );
	void buildRemoveMovementLimitsString( CvWStringBuffer& szBuffer, TechTypes eTech, bool bList = false, bool bPlayerContext = false );	
